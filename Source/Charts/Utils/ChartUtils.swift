...
{
    public static var _defaultValueFormatter: IValueFormatter = ChartUtils.generateDefaultValueFormatter()
    ...
    public class func drawMultilineText(context: CGContext, text: String, knownTextSize: CGSize, point: CGPoint, attributes: [NSAttributedString.Key : Any]?, constrainedToSize: CGSize, anchor: CGPoint, angleRadians: CGFloat)
    {
    ...
    public class func drawMultilineText(context: CGContext, text: String, point: CGPoint, attributes: [NSAttributedString.Key : Any]?, constrainedToSize: CGSize, anchor: CGPoint, angleRadians: CGFloat)
    {
    ...
    public class func generateDefaultValueFormatter() -> IValueFormatter
    {
