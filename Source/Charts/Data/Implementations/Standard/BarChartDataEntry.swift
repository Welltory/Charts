...
open class BarChartDataEntry: ChartDataEntry
{
    ...
    public var _yVals: [Double]?
    
    /// the ranges for the individual stack values - automatically calculated
    public var _ranges: [Range]?
    
    /// the sum of all negative values this entry (if stacked) contains
    public var _negativeSum: Double = 0.0
    
    /// the sum of all positive values this entry (if stacked) contains
    public var _positiveSum: Double = 0.0
    ...
    ///   - vals:
    /// - Returns:
    public static func calcSum(values: [Double]?) -> Double
    {
