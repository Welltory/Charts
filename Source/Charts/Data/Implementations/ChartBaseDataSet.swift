...
open class ChartBaseDataSet: NSObject, IChartDataSet, NSCopying
{
    ...
    public var _valueFormatter: IValueFormatter?
    ...
    /// - Returns: The color at the specified index that is used for drawing the values inside the chart. Uses modulus publicly.
