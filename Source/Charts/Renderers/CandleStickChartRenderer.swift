...
open class CandleStickChartRenderer: LineScatterCandleRadarRenderer
{
    ...
    open var _shadowPoints = [CGPoint](repeating: CGPoint(), count: 4)
    open var _rangePoints = [CGPoint](repeating: CGPoint(), count: 2)
    open var _openPoints = [CGPoint](repeating: CGPoint(), count: 2)
    open var _closePoints = [CGPoint](repeating: CGPoint(), count: 2)
    open var _bodyRect = CGRect()
