...
{
    public lazy var accessibilityXLabels: [String] = {
        var labels: [String] = []
    ...
    public func drawDataSet(context: CGContext, dataSet: IRadarChartDataSet, mostEntries: Int)
    {
        guard let chart = chart else { return }
    ...
    public var _webLineSegmentsBuffer = [CGPoint](repeating: CGPoint(), count: 2)
    ...
    public func drawHighlightCircle(
        context: CGContext,
    ...
    public func createAccessibleElement(withDescription description: String,
