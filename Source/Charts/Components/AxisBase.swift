...
open class AxisBase: ComponentBase
{
    ...
    open var _axisValueFormatter: IAxisValueFormatter?
    ...
    open var _centerAxisLabelsEnabled = false
    ...
    open var _limitLines = [ChartLimitLine]()
    ...
    open var _granularity = Double(1.0)
    ...
    open var _customAxisMin: Bool = false
    
    /// Flag indicating that the axis-max value has been customized
    open var _customAxisMax: Bool = false
