...
open class Highlight: NSObject
{
    ...
    public var _x = Double.nan
    
    /// the y-value of the highlighted value
    public var _y = Double.nan
    
    /// the x-pixel of the highlight
    public var _xPx = CGFloat.nan
    
    /// the y-pixel of the highlight
    public var _yPx = CGFloat.nan
    ...
    public var _axis: YAxis.AxisDependency = YAxis.AxisDependency.left
