...
open class PieChartView: PieRadarChartViewBase
{
    ...
    public var _drawEntryLabelsEnabled = true
    ...
    public var _drawHoleEnabled = true
    
    public var _holeColor: NSUIColor? = NSUIColor.white
    
    /// Sets the color the entry labels are drawn with.
    public var _entryLabelColor: NSUIColor? = NSUIColor.white
    
    /// Sets the font the entry labels are drawn with.
    public var _entryLabelFont: NSUIFont? = NSUIFont(name: "HelveticaNeue", size: 13.0)
    
    /// if true, the hole will see-through to the inner tips of the slices
    public var _drawSlicesUnderHoleEnabled = false
    
    /// if true, the values inside the piechart are drawn as percent values
    public var _usePercentValuesEnabled = false
    
    /// variable for the text that is drawn in the center of the pie-chart
    public var _centerAttributedText: NSAttributedString?
    
    /// the offset on the x- and y-axis the center text has in dp.
    public var _centerTextOffset: CGPoint = CGPoint()
    
    /// indicates the size of the hole in the center of the piechart
    ///
    /// **default**: `0.5`
    public var _holeRadiusPercent = CGFloat(0.5)
    
    public var _transparentCircleColor: NSUIColor? = NSUIColor(white: 1.0, alpha: 105.0/255.0)
    
    /// the radius of the transparent circle next to the chart-hole in the center
    public var _transparentCircleRadiusPercent = CGFloat(0.55)
    
    /// if enabled, centertext is drawn
    public var _drawCenterTextEnabled = true
    
    public var _centerTextRadiusPercent: CGFloat = 1.0
    
    /// maximum angle for this pie
    public var _maxAngle: CGFloat = 360.0
    ...
    public func calcAngle(_ value: Double) -> CGFloat
    {
        return calcAngle(value: value, yValueSum: (_data as! PieChartData).yValueSum)
    }
    
    /// calculates the needed angle for a given value
    public func calcAngle(value: Double, yValueSum: Double) -> CGFloat
    {
