...
open class ChartViewBase: NSUIView, ChartDataProvider, AnimatorDelegate
{
    ...
    public var _defaultValueFormatter: IValueFormatter? = DefaultValueFormatter(decimals: 0)
    
    /// object that holds all data that was originally set for the chart, before it was modified or any filtering algorithms had been applied
    public var _data: ChartData?
    
    /// Flag that indicates if highlighting per tap (touch) is enabled
    public var _highlightPerTapEnabled = true
    ...
    public var _legendRenderer: LegendRenderer!
    ...
    public var _indicesToHighlight = [Highlight]()
    ...
    public func setupDefaultFormatter(min: Double, max: Double)
    {
    ...
    public func drawDescription(context: CGContext)
    {
    ...
    public func drawMarkers(context: CGContext)
    {
    ...
    public var _viewportJobs = [ViewPortJob]()
