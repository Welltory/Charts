...
open class BarLineChartViewBase: ChartViewBase, BarLineScatterCandleBubbleChartDataProvider, NSUIGestureRecognizerDelegate
{
    ...
    public var _maxVisibleCount = 100
    
    /// flag that indicates if auto scaling on the y axis is enabled
    public var _autoScaleMinMaxEnabled = false
    
    public var _pinchZoomEnabled = false
    public var _doubleTapToZoomEnabled = true
    public var _dragXEnabled = true
    public var _dragYEnabled = true
    
    public var _scaleXEnabled = true
    public var _scaleYEnabled = true
    ...
    public var _leftAxisTransformer: Transformer!
    public var _rightAxisTransformer: Transformer!
    ...
    public var _customViewPortEnabled = false
    ...
    public var _autoScaleLastLowestVisibleX: Double?
    public var _autoScaleLastHighestVisibleX: Double?
    ...
    public func prepareValuePxMatrix()
    {
    ...
    public func prepareOffsetMatrix()
    {
    ...
    public func calculateLegendOffsets(offsetLeft: inout CGFloat, offsetTop: inout CGFloat, offsetRight: inout CGFloat, offsetBottom: inout CGFloat)
    {
    ...
    public func drawGridBackground(context: CGContext)
    {
    ...
    public var _isDragging = false
    public var _isScaling = false
    public var _gestureScaleAxis = GestureScaleAxis.both
    public var _closestDataSetToTouch: IChartDataSet!
    public var _panGestureReachedEdge: Bool = false
    public weak var _outerScrollView: NSUIScrollView?
    
    public var _lastPanPoint = CGPoint() /// This is to prevent using setTranslation which resets velocity
    
    public var _decelerationLastTime: TimeInterval = 0.0
    public var _decelerationDisplayLink: NSUIDisplayLink!
    public var _decelerationVelocity = CGPoint()
    ...
    @objc public func doubleTapGestureRecognized(_ recognizer: NSUITapGestureRecognizer)
    {
        if _data === nil
        {
            return
    ...
    #if !os(tvOS)
    @objc public func pinchGestureRecognized(_ recognizer: NSUIPinchGestureRecognizer)
    {
    ...
    public func performPanChange(translation: CGPoint) -> Bool
    {
    ...
    public func isTouchInverted() -> Bool
    {
    ...
    @objc public func decelerationLoop()
    {
    ...
    public func nsuiGestureRecognizerShouldBegin(_ gestureRecognizer: NSUIGestureRecognizer) -> Bool
    {
